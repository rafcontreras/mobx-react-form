...
var Field = (_class = function (_Base) {
  ...
  function Field(_ref2) {
    ...
    _this.debouncedValidation = (0, _debounce2.default)(_this.validate, _this.state.options.get("validationDebounceWait", _this), _this.state.options.get("validationDebounceOptions", _this));
...
var prototypes = exports.prototypes = (_obj = {
  ...
  initMOBXEvent: function initMOBXEvent(type) {
    if (!(0, _isArray2.default)(this["$" + type])) return;
