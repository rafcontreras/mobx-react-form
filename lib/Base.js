...
var Base = (_class = function () {
  function Base() {
    ...
    this.intercept = function (opt) {
      return _this.MOBXEvent((0, _isFunction2.default)(opt) ? { type: "interceptor", call: opt } : _extends({ type: "interceptor" }, opt));
    };

    this.observe = function (opt) {
      return _this.MOBXEvent((0, _isFunction2.default)(opt) ? { type: "observer", call: opt } : _extends({ type: "observer" }, opt));
    };
