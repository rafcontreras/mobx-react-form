...
var hasSome = function hasSome(obj, keys) {
  return (0, _some2.default)(keys, (0, _partial2.default)(has, obj));
};
...
var allowNested = function allowNested(field, strictProps) {
  return (0, _isObject2.default)(field) && !(0, _isDate2.default)(field) && !has(field, "fields") && (!hasSome(field, [].concat(_toConsumableArray(_props2.default.field), _toConsumableArray(_props2.default.validation), _toConsumableArray(_props2.default.function), _toConsumableArray(_props2.default.handlers))) || strictProps);
};
