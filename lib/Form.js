...
var _isEqual = require("lodash-es/isEqual");
...
var Form = (_class = function (_Base) {
  ...
  function Form() {
    ...
    var initial = (0, _each2.default)({
      ...
      return (0, _isFunction2.default)(_this[key]) ? (0, _merge2.default)(val, _this[key].apply(_this, [_this])) : val;
    });
    ...
    _this.debouncedValidation = (0, _debounce2.default)(_this.validate, _this.state.options.get("validationDebounceWait"), _this.state.options.get("validationDebounceOptions"));
